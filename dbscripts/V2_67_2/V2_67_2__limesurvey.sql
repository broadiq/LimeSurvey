...
INSERT INTO `lime_settings_global` VALUES ('DBVersion','263'),('SessionName','XTug]eZ}q,=`6eFBxd3Y]-Oe;^-|&>&bznMHl`KMKm>p+]@5B/1S9ti:GyBJt{(c'),('sitename','LimeSurvey'),('siteadminname','Administrator'),('siteadminemail','your-email@example.net'),('siteadminbounce','your-email@example.net'),('defaultlang','en');
...
INSERT INTO `lime_users` VALUES (1,'admin','f642ec58af10773692874f17aab724962f1602d92ecf6bcafcba75be0ef680c6','Administrator',0,'en','your-email@example.net','default','default','default',NULL,1,'2018-04-12 21:15:26',NULL);
...
-- Dump completed on 2018-04-12 15:19:00
